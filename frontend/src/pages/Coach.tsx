...
export default function Coach() {
    ...
    async function fetchTodaysClasses() {
      ...
      try {
        ...
        const countsMap: Record<
          string,
          { reserved: number; checked_in: number }
        > = {};
        classIds.forEach((id) => {
  ...
  useEffect(() => {
    ...
    const classId = selectedClassId; // Capture for type narrowing
    ...
    async function fetchRoster() {
      ...
      try {
        ...
        if (rosterError || !data) {
          console.warn(
            "Supabase roster fetch failed, using mock data:",
            rosterError
          );
          // Use mock data
        ...
        // Filter out cancelled reservations and map to ClassRosterEntry
        const rosterEntries: ClassRosterEntry[] = data
